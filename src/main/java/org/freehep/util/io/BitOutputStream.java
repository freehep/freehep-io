 ...
 * @version $Id: src/main/java/org/freehep/util/io/BitOutputStream.java 96b41b903496 2005/11/21 19:50:18 duns $
 */
public class BitOutputStream extends CompressableOutputStream implements
    ...
    /**
     * @param number value to calculate bits for
    ...
    /**
     * @param number value to calculate bits for
     * @param signed true if the value if signed (< 0)
     * @return number of bits needed to store value
     */
